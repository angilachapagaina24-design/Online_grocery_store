...
public class OrderDAO {
    ...
    public int placeOrder(int userId, double totalAmount,
        ...
        try (Connection con = DBGroceryConfig.getConnection()) {
            ...
            // Step 2: order_items table ma each cart item insert
        ...
        return generatedOrderId; // success bhaye order_id, fail bhaye -1
    }
}