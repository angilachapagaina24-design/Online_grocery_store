...
<nav class="al-navbar">
    <div class="al-navbar__inner">
        ...
        <div class="al-navbar__actions">
            ...
            <a href="${pageContext.request.contextPath}/LogoutServlet" class="al-navbar_btn al-navbar_btn--outline">Sign Out</a>
        </div>
...
<div class="pf-layout">
    ...
    <aside class="pf-sidebar">
        ...
        <nav class="pf-nav">
            <a href="${pageContext.request.contextPath}/ProfileServlet" class="pf-nav_link pf-nav_link--active">
        ...
        <div class="pf-card">
            ...
            <div class="pf-info">
                ...
                <div class="pf-info__row">
                    ...
                    <span class="pf-info_value"><%= email != null ? email : "<span class='pf-info_empty'>Not set</span>" %></span>
                </div>
                <div class="pf-info__row">
                    <span class="pf-info__label">Phone</span>
                    <span class="pf-info_value"><%= phone != null ? phone : "<span class='pf-info_empty'>Not set</span>" %></span>
                </div>
                <div class="pf-info__row">
                    <span class="pf-info__label">Address</span>
                    <span class="pf-info_value"><%= (address != null && !address.isEmpty()) ? address : "<span class='pf-info_empty'>Not set</span>" %></span>
                </div>
            </div>
